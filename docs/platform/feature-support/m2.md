...
| Devicetree         | 6.18               | 6.18                              | 6.18                 | 6.18                 |
...
| Bluetooth          | linux-asahi        | 6.18                              | 6.18                 | linux-asahi          |
...
You can try it by enabling `hdmi_audio` parameter in `appledrm` kernel module.
